...
<head>
    ...
    <script src="/js/validates/certificateValidate"></script>
                ...
                <div class="container pt-3 container text-center">
                    <div>
                        ...
                        <form action="{{ route('certificates.store') }}" method="POST">
                            ...
                            <button type="submit" id="generateCertificateBtn" onclick="validateCertificateForm()" class="btn btn-success mt-2">Generar certificado</button>
                        </form>
                    </div>
                </div>
            </div>
