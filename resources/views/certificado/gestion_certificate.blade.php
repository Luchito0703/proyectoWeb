                ...
                <div class="container pt-3 container text-center">
                    <div>
                        ...
                        <form action="{{ route('certificates.store')}}" method="post">
                            @csrf
                            <label for="id_certificate">Ingresar Id del certificado</label>
                            <input type="text" id="id_certificate" name="id_certificate" required>

                            <div class="form-group mt-3">
                            <label for="contratista">Identificación del contratista</label>
                            <select name="id_contra" id="contratista" required> 
