                ...
                <div class="container pt-3 container text-center">
                    ...
                    <form action="{{ route('loans.update',$loan->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control text-center" id="prestamo" name="id_prest" value="{{$loan->id_prest}}">
                        </div>

                        <div class="form-group">
                            <label for="contratista" class="mt-2">Identificación del contratista</label>
                            <select name="id_contractor" class="form-control text-center" id="contratista" value="{{$loan->id_contractor}}"> 
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_equipment" class="form-control text-center" id="equipo" value="{{$loan->id_equipment}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control text-center" name="date_loan" id="prestacion" value="{{$loan->date_loan}}">
                        </div>

                        <div class="form-group">
                            <label for="devolucion" class="mt-2">Fecha de devolución</label>
                            <input type="date" class="form-control text-center" name="date_devolution" id="devolucion" value="{{$loan->date_devolution}}">
                        </div>

                        <button type="submit" class="btn btn-success mt-3" onclick="validateLoanForm()">Actualizar</button>
                    </form>
                </div>
            </div>
        </div>
